...
module SteamDonkey
  class Cf < Thor
    ...
    method_option :columns, :aliases => '-c', :default => 'Id,Name,CreationTime', :desc => 'Columns to display'
    method_option :filter_columns, :aliases => '-f', :default => '', :desc => 'Filters to apply'
    method_option :sort, :aliases => '-s', :default => 'CreationTime,Name', :desc => 'Columns to sort by'
    map :ls => :list
    def list
